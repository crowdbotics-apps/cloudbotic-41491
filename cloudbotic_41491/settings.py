"""
Django settings for cloudbotic_41491 project.
...
ROOT_URLCONF = 'cloudbotic_41491.urls'
...
WSGI_APPLICATION = 'cloudbotic_41491.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cloudbotic_41491 API",
    "DESCRIPTION": "API documentation for cloudbotic_41491 App",
    "VERSION": "v1",
}
